...
export { default as UPSCALED_00235 } from './Player_Portraits/UPSCALED_00235.png';
...
export { default as MAP_ICON_SNOWY_FOREST }       from './Map_Icons_Snow/SNOWY_FOREST.png';
export { default as MAP_ICON_GREEN_TREE_AT_SNOW } from './Map_Icons_Snow/GREEN_TREE_AT_SNOW.png';
export { default as MAP_ICON_BIG_SNOW_CAVE }      from './Map_Icons_Snow/BIG_SNOW_CAVE.png';
export { default as MAP_ICON_BIG_SNOW_CAVE_2 }    from './Map_Icons_Snow/BIG_SNOW_CAVE_2.png';
export { default as MAP_ICON_HOME }               from './Map_Icons_Snow/HOME.png';
export { default as MAP_ICON_SNOW_CHERRY_PATH_1 } from './Map_Icons_Snow/SNOW_CHERRY_PATH_1.png';
export { default as MAP_ICON_SNOW_FIELD_PATH_1 }  from './Map_Icons_Snow/SNOW_FIELD_PATH_1.png';
export { default as MAP_ICON_SNOW_FIELD_PATH_2 }  from './Map_Icons_Snow/SNOW_FIELD_PATH_2.png';
export { default as MAP_ICON_SNOW_FIELD_PATH_3 }  from './Map_Icons_Snow/SNOW_FIELD_PATH_3.png';
export { default as MAP_ICON_SNOW_FIELD_SHRINE }  from './Map_Icons_Snow/SNOW_FIELD_SHRINE.png';
export { default as MAP_ICON_SNOW_IRON_GATE }     from './Map_Icons_Snow/SNOW_IRON_GATE.png';
export { default as MAP_ICON_SNOW_MOUNTAIN_1 }    from './Map_Icons_Snow/SNOW_MOUNTAIN_1.png';
export { default as MAP_ICON_SNOW_MOUNTAIN_2 }    from './Map_Icons_Snow/SNOW_MOUNTAIN_2.png';
export { default as MAP_ICON_SNOW_AND_WATER }     from './Map_Icons_Snow/SNOW_AND_WATER.png';
export { default as MAP_ICON_SNOW_AND_WATER_2 }   from './Map_Icons_Snow/SNOW_AND_WATER_2.png';
export { default as MAP_ICON_SNOWY_FIELD_BAMBOO } from './Map_Icons_Snow/SNOWY_FIELD_BAMBOO.png';
export { default as MAP_ICON_SNOWY_FIELD_DEN }    from './Map_Icons_Snow/SNOWY_FIELD_DEN.png';
export { default as MAP_ICON_SUNSET }             from './Map_Icons_Snow/SUNSET.png';
export { default as MAP_ICON_SUNSET_2 }           from './Map_Icons_Snow/SUNSET_2.png';
export { default as MAP_ICON_TREE_AT_SNOW }       from './Map_Icons_Snow/TREE_AT_SNOW.png';
export { default as MAP_ICON_WATER }              from './Map_Icons_Snow/WATER.png';
