...
export const SAMURAI_CARDS = [
  {
    ...
    cost: {},
    icon: '⚔️',
    image: 'FOX_SAMURAI_HEAVY_STRIKE',
    color: '#f97316',
  ...
  },
  {
    ...
    icon: '⚔️',
    image: 'FOX_SAMURAI_STREAM_SLASH',
    color: '#38bdf8',
  ...
  },
  {
    ...
    cost: { BATTLE_SPIRIT: 3 },
    icon: '🔥',
    image: 'FOX_SAMURAI_FLAME_STRIKE',
    color: '#ef4444',
  ...
  },
  {
    ...
    icon: '❄️',
    image: 'FOX_SAMURAI_FREEZE_SLASH',
    color: '#38bdf8',
